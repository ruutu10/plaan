...
class AuditLogController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        // so it brings that night — and the night's format — along too, and a
        // recording reads by the same night for the same reason.
        $activities = Activity::query()
            ...
            ->loadMorph('subject', [
                ...
                PerformanceRecording::class => ['performance.format'],
            ]);
