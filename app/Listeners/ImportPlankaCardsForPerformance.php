...
/**
 * Run the Planka import narrowed to the card one performance was announced on.
 *
 * The work is the ordinary {@see ImportPlankaPerformances} command with its
 * card filter set, so a re-read by hand and the nightly run do exactly the same
...
class ImportPlankaCardsForPerformance implements ShouldBeUnique, ShouldQueue
{
     ...
     * the same card out for the rest of the day.
     */
     ...
     * — and two performances of one shared evening ask about one card between
     * them.
     */
