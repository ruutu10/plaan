        ...
        <main class="mx-auto max-w-[1160px] px-6 pt-16 pb-16">
            ...
            >
                <div class="mb-5 flex items-center gap-2">
                    <Diamond :size="8" />
                    <span
                        class="text-xs font-bold tracking-[0.1em] text-r10-grey-500 uppercase"
                    >
                        Esinejatele
                    </span>
                </div>
                ...
                <h1
                    class="font-r10-display text-3xl font-black tracking-[0.02em] text-r10-navy sm:text-4xl"
                >
                ...
                <p class="mt-4 text-[15px] leading-relaxed text-r10-grey-700">
                    ...
                    saata oma tehnikaplaani, siis saad siin täita tehnikaplaani
                    vormi.
                </p>
                <p class="mt-4 text-[15px] leading-relaxed text-r10-grey-700">
                    Nii teame juba ette, millist heli, valgust ja tehnikat sinu
                    etendus vajab.
                </p>
