{{--
    ...
    One reader: the performer it is addressed to. $planUrl is a magic link that
    signs them in and opens the wizard on the right night, which is why this
    letter goes to them alone and to nobody else — not even the house's own
    crew.
--}}
@php
...
@section('title', 'Tehnikaplaan on esitamata')
